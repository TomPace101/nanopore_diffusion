...
$$J = - D_{\text{bulk}}\int dA\, \frac{\partial c}{\partial x}$$
...
$$J = - D_{\text{eff}} A_{\text{cell}} \frac{\Delta c}{\Delta x}$$
...
$$D_{\text{eff}} = \frac{J}{A_{\text{cell}}} \frac{\Delta x}{\Delta c}$$
...
and must therefore be multiplied by $4$.
With $A_{\text{cell}} = 4 Lx Ly$, we have:

$$D_{\text{eff}} = \frac{4 J}{4 Lx Ly} \frac{\Delta x}{\Delta c}
 = \frac{J}{Lx Ly} \frac{\Delta x}{\Delta c}$$
