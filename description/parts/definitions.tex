...
\begin{description}
  ...
  \frac{1 \,\mathrm{mole}}{6.02 \cdot 10^{23} \,\mathrm{particles}} \left(\frac{10^9 \,\mathrm{nm}}{\mathrm{m}}\right)^3 
  \frac{(10^{-1}\,\mathrm{m})^3}{1 \,\mathrm{L}}
  = 1.66 \,\frac{\mathrm{moles}}{\mathrm{L}}$
  \item [millmoles/liter (mM):] $\frac{1 \,\mathrm{particle}}{\mathrm{nm}^3} = 1,661 \,\frac{10^{-3}\,\mathrm{moles}}{\mathrm{L}}$
\end{description}
