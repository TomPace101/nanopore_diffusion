...
class MeshParameters(common.ParameterSet):
  ...
  Attributes:
    ...
    To be generated by methods:
      ...
      paramlocsfile = path to parameter locations file"""
  __slots__=('meshname','geomdefname','tmplvalues','geomdef','geofile','_folders','paramlocsfile')
  ...
  def __init__(self,**kwd):
    ...
    self.paramlocsfile=osp.join(FS.paramlocs_outfolder,self.basename,self.meshname+'.yaml')
...
def prepare_template_input(geom, paramdef):
  ...
  #Parametric locations file
  t_input['paramlocsfile']=paramdef.paramlocsfile
