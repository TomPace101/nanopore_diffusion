...
def list_outputfiles(cmdlist):
  ...
  The results.yaml file is included as well.
  Arguments:
...
def dosolve(modelparams,meshparams):
  ...
  tdef = {'name':modelparams.modelname,
          'file_dep':[osp.join(solverfolder,solver_codefile)]+xmlfiles, #This takes care of dependency on mesh
